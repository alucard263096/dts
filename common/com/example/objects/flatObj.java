...
public class flatObj {
    ...
    public void setFlatId(int longUserId){flatId=longUserId;}
    
    public int getFlatTypeId(){return flatTypeId;}
    public void setFlatTypeId(int longUserId){flatTypeId=longUserId;}
    
    public int getFloorId(){return floorId;}
    public void setFloorId(int longUserId){floorId=longUserId;}
    
    public String getFlatName(){return flatName;}
    public void setFlatName(String longAreaName){flatName=longAreaName;}
